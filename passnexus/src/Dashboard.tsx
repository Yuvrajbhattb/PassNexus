    ...
    return (
        <div className="min-h-screen bg-slate-900 flex">
            ...
            <motion.aside
                initial={{ x: -300 }}
                animate={{ x: 0 }}
                className="w-64 bg-gradient-to-b from-slate-800 to-slate-900 border-r border-neon-blue/20 p-6"
            >
                <div className="mb-8">
            ...
            <div className="flex-1 flex flex-col">
                {/* Header */}
                <header className="bg-slate-800/50 backdrop-blur-sm border-b border-slate-700 px-8 py-4">
